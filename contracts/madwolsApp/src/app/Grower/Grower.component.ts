...
export class GrowerComponent implements OnInit {
  ...
  isFairTrade = new FormControl('', Validators.required);
  growerId = new FormControl('', Validators.required);
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      ...
      'isFairTrade': this.isFairTrade.value,
      'growerId': this.growerId.value,
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceGrower.updateParticipant(form.get('growerId').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.isFairTrade) {
        formObject.isFairTrade = result.isFairTrade;
      } else {
        formObject.isFairTrade = null;
      }

      if (result.growerId) {
        formObject.growerId = result.growerId;
      } else {
        formObject.growerId = null;
      }
